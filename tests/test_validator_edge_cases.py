...
print("[OK] Case 1 (minimal) passes")
print("[OK] Case 2 (at limits) passes")
print("[OK] Case 3 (1 char over) fails with correct errors")
print("[OK] Case 4 (6 positions) fails")
print("[OK] Case 5 (5 bullets) fails")
print("[OK] Case 6 (exactly 2.0 pages) passes")
