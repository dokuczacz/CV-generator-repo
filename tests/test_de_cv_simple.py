#!/usr/bin/env python3
"""Opt-in local E2E smoke for German CV flow against a running local Functions host."""
...
@pytest.mark.skipif(
    ...
    reason="Set RUN_LOCAL_DE_E2E=1 to run local German E2E smoke test",
)
def test_de_cv_simple_flow_local_host():
    ...
    assert german_count > english_count, "Expected German-dominant output"
